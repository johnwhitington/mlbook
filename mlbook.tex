...
\usepackage{comment}\excludecomment{osfbookends}
...
\vspace{20mm}
{\LARGE
  \noindent\itshape Paperback and Kindle versions are available at \href{https://www.amazon.com/OCaml-Very-Beginning-John-Whitington/dp/0957671105/}{Amazon}. HTML version available at \href{https://ocaml-book.com/}{ocaml-book.com}.\par}
...
\vspace{50mm}
{
\noindent Licensed under the \href{https://creativecommons.org/licenses/by-nc-sa/4.0/}{Creative Commons BY-NC-SA 4.0}\par}
...
\noindent Reprinted with corrections July 2022
...
\noindent Since the inner pattern match has only one form, and is complete, we can use \texttt{\textbf{let}} instead:
