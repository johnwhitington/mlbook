...
\noindent The \texttt{\textbf{while}} loop continues until the contents of the reference \texttt{t} is greater than or equal to \texttt{x}. At that point, it ends, and the content of \texttt{t} is returned from the function. Again, note that the type of the whole \,\texttt{\textbf{while}\! \ldots\ \!\textbf{do} \!\ldots\ \!\textbf{done}}\ \! construct is \textbf{\textsf{unit}}.
