...
\textit{Hints may be found after all the answers.}
...
\texttt{type \textquotesingle a mtree = Branch of \textquotesingle a * \textquotesingle a mtree list}
\end{minipage}
\end{center}
\smspace
