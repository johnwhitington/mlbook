...
\noindent \lettrine[loversize=0.1,nindent=0em]{1}{}
...
{
\noindent\lettrine[loversize=0.1,findent=2pt,nindent=0em]{2}{}
...
{\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{3}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{4}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{5}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{6}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{7}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{8}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{9}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{10}{}
...
{
\noindent \lettrine[loversize=0.1,nindent=0em]{11}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{12}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{13}{}
...
{
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{14}{}
...
{
\noindent\lettrine[loversize=0.1,findent=2pt,nindent=0em]{15}{}
...
\noindent \lettrine[loversize=0.1,findent=2pt,nindent=0em]{16}{}
...
$\texttt{\ \ |   \_::t -> 1 + length t}$\hfill\makebox{\textit{\texttt{h} is the head, \texttt{t} the tail}}
\end{minipage}}
%\end{center}
\smspace
...
\noindent The name of our new type is \textrm{colour}. It has four \index{type!constructor}\textit{constructors}, written with an initial capital letter: \texttt{Red}, \texttt{Green}, \texttt{Blue}, and \texttt{Yellow}. These are the possible forms a value of type \textrm{colour} may take. Now we can build values of type \textrm{color}:
...
\noindent\begin{tabular}{@{}lll@{}} \toprule
  ...
  \texttt{[Red; RGB (20, 20, 20)]} & \texttt{Cons (Red, Cons (RGB (20, 20, 20), Nil))} & \textrm{color sequence} \\ \bottomrule
\end{tabular}
\smspace
...
\begin{enumerate}
  ...
  \item Use this function to write one which, given a \textrm{rect \textbf{list}}, returns another such list which has the smallest total width and whose members are sorted widest first.
...
\noindent The \texttt{\textbf{while}} loop continues until the contents of the reference \texttt{t} is greater than \texttt{x}. At that point, it ends, and the contents of \texttt{t} is returned from the function. Again, note that the type of the whole \,\texttt{\textbf{while}\! \ldots\ \!\textbf{do} \!\ldots\ \!\textbf{done}}\ \! construct is \textbf{\textrm{unit}}.
...
$\texttt{\ \ |   \_::b::t -> b ::\ even\_elements t}$\hfill\makebox{\textit{\texttt{h} is the head, \texttt{t} the tail}}
\end{minipage}}
%\end{center}
\smspace
...
$\texttt{\ \ \pmatch l \pwith}$\\
$\texttt{\ \ \ \ [] -> []}$\hfill\makebox{\textit{no more}}\\
...
\subsection*{4}
This will have the type \textrm{\textbf{\textmd{(}$\alpha$ list $\times$ $\beta$ list\textmd{)} $\rightarrow$ \textmd{(}$\alpha$ $\times$ $\beta$\textmd{)} list}}. For the first time, we need to return a pair, building up both result lists element by element. This is rather awkward, since we will need the tails of both of the eventual results, so we can attach the new heads. We can do this by pattern matching.
...
%\begin{center}
\noindent\fbox{\begin{minipage}{\textwidth}
\noindent\texttt{equal\_shape :}\textrm{ $\alpha$ tree $\rightarrow$ $\alpha$ tree $\rightarrow$ \textbf{bool}}\\
\\
